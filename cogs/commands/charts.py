...
class charts(commands.Cog):
    ...
    async def chart_render(self, ctx):
        ...
        try:
            await ctx.warning("Please use the slash command `/chart_render` to run this action.")
        except Exception:
            try:
                await ctx.send("Please use the slash command `/chart_render` to run this action.")
            except Exception:
                pass
